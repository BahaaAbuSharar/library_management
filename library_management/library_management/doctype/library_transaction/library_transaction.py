...
class LibraryTransaction(Document):
    ...
    def validate_return(self):
        ...
        # check if the member is the one who issued the article
        ...
        if not issued_transaction:
            frappe.throw("The member did not issue this article")   
	...
	# validate the maximum limit of articles that can be issued to a member
